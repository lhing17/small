...
function CreateNeutralHostile takes nothing returns nothing
    ...
    call SetUnitState(u, UNIT_STATE_MANA, 0)
    set u=CreateUnit(p, 'n00F', - 2149.0, - 12710.9, 230.346)
    ...
    set u=CreateUnit(p, 'n00F', - 2026.9, - 13142.2, 31.609)
    set u=CreateUnit(p, 'n00F', - 1663.2, - 13198.7, 316.196)
    set u=CreateUnit(p, 'n00F', - 2126.6, - 13254.3, 273.996)
    set u=CreateUnit(p, 'n00F', - 1949.4, - 13289.3, 246.673)
...
call ExecuteFunc("jasshelper__initstructs188027234")
...
function jasshelper__initstructs188027234 takes nothing returns nothing
