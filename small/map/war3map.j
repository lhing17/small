...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'n00M', 12614.1, - 739.3, 67.370)
    call SetUnitState(u, UNIT_STATE_MANA, 0)
    set u=CreateUnit(p, 'n00M', 12599.4, - 788.2, 240.420)
    call SetUnitState(u, UNIT_STATE_MANA, 0)
    ...
    call SetUnitState(u, UNIT_STATE_MANA, 0)
    set u=CreateUnit(p, 'n00J', 8124.8, - 12840.5, 176.325)
    call SetUnitState(u, UNIT_STATE_MANA, 0)
    ...
    call SetUnitState(u, UNIT_STATE_MANA, 0)
    set u=CreateUnit(p, 'n00A', 9643.9, - 12853.2, - 57.017)
    call SetUnitState(u, UNIT_STATE_MANA, 0)
    ...
    call SetUnitState(u, UNIT_STATE_MANA, 0)
    set u=CreateUnit(p, 'n00F', - 1442.5, - 14321.9, 318.712)
    set u=CreateUnit(p, 'n00F', - 1156.5, - 14353.7, 228.984)
    set u=CreateUnit(p, 'n00F', - 1054.3, - 14663.2, 87.531)
    set u=CreateUnit(p, 'n00F', - 1055.1, - 14931.0, 111.097)
    set u=CreateUnit(p, 'n00F', - 1269.9, - 14624.0, 136.334)
    set u=CreateUnit(p, 'n00F', - 1294.4, - 14848.5, 91.849)
    set u=CreateUnit(p, 'n00F', - 1548.0, - 14949.1, 223.425)
    set u=CreateUnit(p, 'n00F', - 1658.2, - 14638.8, 204.319)
    set u=CreateUnit(p, 'n00F', - 1517.6, - 14549.4, 352.090)
    set u=CreateUnit(p, 'n00F', - 3140.1, - 14351.8, 358.989)
    set u=CreateUnit(p, 'n00F', - 3018.5, - 14629.0, 206.154)
    set u=CreateUnit(p, 'n00F', - 3075.3, - 14804.3, 303.023)
    set u=CreateUnit(p, 'n00F', - 3130.0, - 14967.1, 54.999)
    set u=CreateUnit(p, 'n00F', - 3234.6, - 15126.8, 251.221)
    set u=CreateUnit(p, 'n00F', - 3422.5, - 14882.1, 322.612)
    set u=CreateUnit(p, 'n00F', - 3608.1, - 14748.4, 39.321)
    set u=CreateUnit(p, 'n00F', - 3429.3, - 14594.9, 125.204)
    set u=CreateUnit(p, 'n00F', - 3327.7, - 14393.4, 176.929)
    set u=CreateUnit(p, 'n00F', - 3222.5, - 14619.3, 300.266)
    set u=CreateUnit(p, 'n00F', - 3489.8, - 13765.4, 53.439)
    set u=CreateUnit(p, 'n00F', - 3250.8, - 13837.3, 87.267)
    set u=CreateUnit(p, 'n00F', - 3479.0, - 13494.9, 146.430)
    set u=CreateUnit(p, 'n00F', - 3344.0, - 13536.1, 151.605)
    set u=CreateUnit(p, 'n00F', - 3161.4, - 13339.6, 192.596)
    set u=CreateUnit(p, 'n00F', - 3001.4, - 13377.8, 333.039)
    set u=CreateUnit(p, 'n00F', - 2829.7, - 13476.4, 26.225)
    set u=CreateUnit(p, 'n00F', - 3062.6, - 13121.8, 316.196)
    set u=CreateUnit(p, 'n00F', - 3426.4, - 13065.4, 31.609)
    set u=CreateUnit(p, 'n00F', - 3526.1, - 13177.4, 273.996)
    set u=CreateUnit(p, 'n00F', - 3348.9, - 13212.4, 246.673)
    set u=CreateUnit(p, 'n00F', - 3218.1, - 12758.9, 271.261)
    set u=CreateUnit(p, 'n00F', - 3263.2, - 12949.9, 155.901)
    set u=CreateUnit(p, 'n00F', - 2992.6, - 12890.9, 37.992)
...
call ExecuteFunc("jasshelper__initstructs167317750")
...
function config takes nothing returns nothing
    ...
    call DefineStartLocation(5, - 12584.1, - 3953.0)
...
function jasshelper__initstructs167317750 takes nothing returns nothing
